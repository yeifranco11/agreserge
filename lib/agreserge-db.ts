...
const requiredOperationalModules: Record<string, string[]> = {
  ...
  'Administrador de Sistemas': ['Agendamiento · Pruebas psicotécnicas', 'Ficha técnica', 'Nómina y comprobantes', 'Solicitudes y firmas', 'AGREBOT'],
};
