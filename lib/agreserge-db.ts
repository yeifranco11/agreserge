...
export const defaultPermissions: Record<string, string[]> = {
  ...
  'Coordinación Administrativa':['Inicio','Dashboard gerente','Psicología','Ficha técnica','Informes de actividades','Asignación mensual','Nómina y comprobantes','Solicitudes y firmas','Trámites administrativos','AGREBOT','Auditoría'],
  'Coordinación Asistencial':['Inicio','Dashboard gerente','Agendamiento · Pruebas psicotécnicas','Ficha técnica','Revisión documental','Mis agremiados','Informes de actividades','Solicitudes y firmas','AGREBOT','Auditoría'],
  ...
  'Coordinación General':['Inicio','Dashboard gerente','Agendamiento · Pruebas psicotécnicas','Parámetros institucionales','Ficha técnica','Revisión documental','Informes de actividades','Asignación mensual','Usuarios y claves','AGREBOT','Auditoría'],
  ...
  'Coordinadora Administrativa y Financiera':['Inicio','Dashboard gerente','Psicología','Informes de actividades','Asignación mensual','Nómina y comprobantes','Solicitudes y firmas','Trámites administrativos','Auditoría','AGREBOT'],
  'Talento Humano':['Inicio','Parámetros institucionales','Usuarios y claves','Psicología','Ficha técnica','AGREBOT'],
  'Psicología':['Inicio','Psicología','Ficha técnica','AGREBOT'],
  ...
  'Director Ejecutivo':['Inicio','Dashboard gerente','Agendamiento · Pruebas psicotécnicas','Parámetros institucionales','Ficha técnica','Revisión documental','Informes de actividades','Asignación mensual','Usuarios y claves','AGREBOT','Auditoría'],
...
const requiredOperationalModules: Record<string, string[]> = {
  ...
  'Coordinación Administrativa': ['Psicología', 'Ficha técnica', 'Nómina y comprobantes', 'Solicitudes y firmas'],
  'Coordinación Asistencial': ['Agendamiento · Pruebas psicotécnicas', 'Ficha técnica', 'Revisión documental', 'Solicitudes y firmas'],
  'Tesorería': ['Nómina y comprobantes'],
  'Coordinación General': ['Agendamiento · Pruebas psicotécnicas', 'Ficha técnica', 'AGREBOT'],
  'Coordinador de Sede': ['Ficha técnica', 'Solicitudes y firmas'],
  'Coordinadora Administrativa y Financiera': ['Psicología', 'Ficha técnica', 'Nómina y comprobantes', 'Solicitudes y firmas'],
  'Coordinador General': ['Ficha técnica'],
  'Talento Humano': ['Psicología', 'Ficha técnica'],
  'Psicología': ['Psicología', 'Ficha técnica'],
  ...
  'Director Ejecutivo': ['Dashboard gerente', 'Agendamiento · Pruebas psicotécnicas', 'Asignación mensual', 'Informes de actividades'],
  'Seguridad y Salud en el Trabajo': ['Dashboard gerente', 'Ficha técnica', 'Informes de actividades'],
  'Administrador de Sistemas': ['Agendamiento · Pruebas psicotécnicas', 'Psicología', 'Ficha técnica', 'Nómina y comprobantes', 'Solicitudes y firmas', 'AGREBOT'],
};
